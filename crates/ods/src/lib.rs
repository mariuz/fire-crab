...
pub use dml::{allocate_page, begin_committed_tx, delete_records, insert_blob_slot, insert_record, update_record_under, update_records, DmlOutcome, InsertOutcome};
