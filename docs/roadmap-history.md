> **Frozen narrative ledger, as of 2026-08-20.** This file is the roadmap as it
> accreted, paragraph by paragraph, newest appended ABOVE older ones - so an item
> reading "still to do" further down is often closed further up (fifteen such
> stale claims are listed under "Stale claims retired" in the live document).
> Nothing here is maintained any more; the commit and the gate named beside each
> item are the record. The live roadmap is `docs/roadmap.md`.
