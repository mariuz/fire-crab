...
>
> **THE ARITHMETIC, COUNTED RATHER THAN REMEMBERED: 29 bullets, 17 struck, 12 live** - HIGH 7 of 7 struck, MEDIUM 10 of 13, **LOW 0 of 9**. The LOW tier has never been probed at all, and its silence here is not evidence about it. (Two figures in an earlier draft of this note - "twelve" MEDIUM bullets and "thirty" in total - were carried from memory and were both wrong, which is the same failure this whole section documents.)
