...
echo '-- a ? INSIDE a subquery: numbered in text order, spelled in at bind --'
both "SELECT ID FROM P WHERE ID IN (SELECT ID FROM J WHERE I = ?) ORDER BY 1" '[1]'
both "SELECT ID FROM P WHERE ID IN (SELECT ID FROM J WHERE I = ?) ORDER BY 1" '["1"]'
both "SELECT ID FROM P WHERE ID IN (SELECT ID FROM J WHERE I = ?) ORDER BY 1" '[null]'
both "SELECT ID FROM P WHERE ID IN (SELECT ID FROM J WHERE I = ?) ORDER BY 1" '["abc"]'
both "SELECT ID FROM P WHERE ID NOT IN (SELECT ID FROM J WHERE I = ?) ORDER BY 1" '[1]'
both "SELECT ID FROM P WHERE ID = (SELECT ID FROM J WHERE I = ?)" '[1]'
both "SELECT ID FROM P WHERE ID IN (SELECT ID FROM J WHERE I = ? AND ID > 0) ORDER BY 1" '[1]'
echo '-- the raise waits for the inner stream; an empty side answers --'
both "SELECT ID FROM P WHERE ID IN (SELECT ID FROM Z WHERE I = ?) ORDER BY 1" '["abc"]'
both "SELECT ID FROM Z WHERE ID IN (SELECT ID FROM P WHERE I = ?) ORDER BY 1" '["abc"]'
both "SELECT ID FROM Z WHERE ID IN (SELECT ID FROM J WHERE I = ?) ORDER BY 1" '[1]'
echo '-- EXISTS / NOT EXISTS carry one too --'
both "SELECT ID FROM P WHERE EXISTS (SELECT 1 FROM J WHERE I = ?) ORDER BY 1" '[1]'
both "SELECT ID FROM P WHERE EXISTS (SELECT 1 FROM J WHERE I = ?) ORDER BY 1" '[9]'
both "SELECT ID FROM P WHERE EXISTS (SELECT 1 FROM J WHERE I = ?) ORDER BY 1" '["abc"]'
both "SELECT ID FROM P WHERE NOT EXISTS (SELECT 1 FROM J WHERE I = ?) ORDER BY 1" '[9]'
both "SELECT ID FROM P WHERE EXISTS (SELECT 1 FROM Z WHERE I = ?) ORDER BY 1" '["abc"]'
echo '-- an inner ? numbers BEFORE an outer one written after it --'
both "SELECT ID FROM P WHERE I = ? AND ID IN (SELECT ID FROM J WHERE I = ?) ORDER BY 1" '[5, 1]'
