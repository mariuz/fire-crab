...
both "PER ROW: a multi-row DELETE walks the count down as it goes" \
  "DELETE FROM LOGT; DELETE FROM Q; COMMIT;
   INSERT INTO Q VALUES (1, 10); INSERT INTO Q VALUES (2, 20);
   INSERT INTO Q VALUES (3, 30); INSERT INTO Q VALUES (4, 40); COMMIT;
   DELETE FROM LOGT; COMMIT;
   DELETE FROM Q; COMMIT;
   SELECT ID, W, N FROM LOGT ORDER BY ID, W; SELECT COUNT(*) AS QN FROM Q;"
both "...and the log rows in the ORDER the statement wrote them" \
  "SELECT ID, W, N FROM LOGT;"
