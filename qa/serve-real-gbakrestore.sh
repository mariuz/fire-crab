...
# (~~an exception refuses~~ - exceptions ride now; the representative
# refusal is a FUNCTION, whose records are their own family)
...
check "an fbk with a FUNCTION refuses fc's restore whole" \
